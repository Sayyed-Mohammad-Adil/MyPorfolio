...
const TechStack = () => {
  const technologies = [
    ...
    { icon: '🟢', name: 'Node.js', color: 'text-yellow-500' },
    ...
    { icon: '💚', name: 'Vue.js', color: 'text-yellow-400' },
    { icon: '🔺', name: 'Angular', color: 'text-red-500' },
    { icon: '🗄️', name: 'PostgreSQL', color: 'text-blue-700' },
    { icon: '🍃', name: 'MongoDB', color: 'text-yellow-600' },
    { icon: '📦', name: 'Npm', color: 'text-blue-400' },
  ];

  return (
    <section id="techstack" className="relative h-16  bg-gray-300 dark:bg-gray-800/50 backdrop-blur-sm flex items-center justify-center overflow-hidden">
      <Marquee
      ...
      >
        {technologies.map((tech, i) => (
          <div key={i} className="flex items-center gap-10 text-gray-900 dark:text-gray-400 whitespace-nowrap">
